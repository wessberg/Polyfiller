	...
	function generateSyntheticFormat(propName, propValue) {
		if (validSyntheticProps[propName] && validSyntheticProps[propName][propValue]) {
			...
			return (
				...
				defineProperty$1(_ref2, propName, propValue),
				defineProperty$1(_ref2, "pattern12", "{" + propName + "}"),
				defineProperty$1(_ref2, "pattern", "{" + propName + "}"),
				_ref2
			);
		}
	}
	...
	var plurals = {
		...
		bs: function bs(n, ord) {
			...
			return (v0 && i10 == 1 && i100 != 11) || (f10 == 1 && f100 != 11)
				? "one"
				: (v0 && i10 >= 2 && i10 <= 4 && (i100 < 12 || i100 > 14)) || (f10 >= 2 && f10 <= 4 && (f100 < 12 || f100 > 14))
				? "few"
				: "other";
		},
		...
		lv: function lv(n, ord) {
			var s = String(n).split("."),
				...
				f10 = f.slice(-1);
			if (ord) return "other";
			return (t0 && n10 == 0) || (n100 >= 11 && n100 <= 19) || (v == 2 && f100 >= 11 && f100 <= 19)
				? "zero"
